...
var _news_agregator = require('./news_agregator.js');

var _content_builder = require('./content_builder.js');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var Configurator = exports.Configurator = function () {
  ...
  _createClass(Configurator, [{
    ...
    value: function initPage() {
      ...
      var _loop = function _loop(i) {
        var news_button = document.createElement('div');
        news_button.className = 'button';
        var newsResource = _news_agregator.NewsAgregator.getNewsById(i);
        news_button.innerHTML = newsResource;
        news_button.addEventListener("click", function (e) {
          _content_builder.ContentBuilder.build(newsResource);
        });
        news_button.addEventListener("click", function (e) {
          _this.isContentLoaded();
        });
        fragment.appendChild(news_button);
      };

      for (var i = 0; i < _news_agregator.NewsAgregator.getNews().length; ++i) {
        _loop(i);
      }
    ...
    key: 'isContentLoaded',
    value: function isContentLoaded() {
      var myEl = document.querySelector('.main');
...
},{"./content_builder.js":3,"./news_agregator.js":4}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var API_KEY = exports.API_KEY = '4c9833664e2b46b6a433407c24c2f128';
...
var _request_wrapper = require('./request_wrapper.js');

var _news_snippet = require('./news_snippet.js');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ContentBuilder = exports.ContentBuilder = function () {
  function ContentBuilder() {
    _classCallCheck(this, ContentBuilder);
  }

  _createClass(ContentBuilder, null, [{
    key: 'build',
    value: function build(source_type) {
      var request_wrapper = new _request_wrapper.RequestWrapper();
      request_wrapper.getResponse(request_wrapper.buildUrl(source_type)).then(function (data) {
        return _news_snippet.NewsSnippet.buildTemplate(data);
      }).catch(function (e) {
        return console.log("ERROR LOG: ", e);
      });
    }
  }]);
...
},{"./news_snippet.js":5,"./request_wrapper.js":6}],4:[function(require,module,exports){
'use strict';
...
var newsArray = exports.newsArray = ['abc-news', 'ars-technica', 'bbc-news', 'google-news-uk', 'reuters'];

var NewsAgregator = exports.NewsAgregator = function () {
  function NewsAgregator() {
    _classCallCheck(this, NewsAgregator);
  }

  _createClass(NewsAgregator, null, [{
    key: 'getNews',
...
var NewsSnippet = exports.NewsSnippet = function () {
  function NewsSnippet() {
    _classCallCheck(this, NewsSnippet);
  }

  _createClass(NewsSnippet, null, [{
    key: 'buildTemplate',
    value: function buildTemplate(data) {
      ...
      data.articles.map(function (item) {
        ...
        var pureDate = publishedAt.substring(0, 10);
        var imgTag = urlToImage ? '<img class=\'image\' alt=\'image to news\' src=\'' + urlToImage + '\'/>' : '';
...
exports.RequestWrapper = undefined;
...
var RequestWrapper = exports.RequestWrapper = function () {
  ...
  _createClass(RequestWrapper, [{
    key: 'buildUrl',
    value: function buildUrl(source_type) {
      var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _constants.API_KEY;

      return 'https://newsapi.org/v2/top-headlines?' + ('sources=' + source_type) + ('&apiKey=' + key);
    }
  }, {
    key: 'getResponse',
    value: function () {
...
},{"./constants.js":2,"whatwg-fetch":333}],7:[function(require,module,exports){
"use strict";
...
},{"./configurator.js":1,"babel-polyfill":8}],8:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":9,"core-js/shim":331,"regenerator-runtime/runtime":332}],9:[function(require,module,exports){
